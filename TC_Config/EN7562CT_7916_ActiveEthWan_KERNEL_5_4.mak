...
# TCSUPPORT_WAN_GPON is not set
# TCSUPPORT_WAN_EPON is not set
...
TCSUPPORT_SWITCH_8850=y
# TCSUPPORT_ETHER_8811 is not set
#
# Driver Feature
#
# TCSUPPORT_DMT_3085 is not set
TCSUPPORT_DMT_3086=y
...
# TCSUPPORT_NPU_WIFI_TX is not set
...
TCSUPPORT_WLAN=y
TCSUPPORT_WLAN_APCLIENT=y
# TCSUPPORT_WLAN_INODE is not set
TCSUPPORT_WLAN_MULTI_CHIP=y
...
TCSUPPORT_TEST_WLAN_SHORTCUT=y
...
TCSUPPORT_WLAN_ANTENNA_DIVERSITY=y
...
TCSUPPORT_MAP_R2=y
# TCSUPPORT_MAP_R2_RELEASE_OPEN is not set
...
TCSUPPORT_UART_DISABLE=y
TCSUPPORT_UART_TX_DISABLE=y
TCSUPPORT_UART_RX_DISABLE=y
...
TCSUPPORT_SNOOPING_SEPERATION=y
...
TCSUPPORT_PARTITIONS_CMDLINE_STR="512k[bootloader],12m[rescue],1280k[reservearea],256k[romfile],5m[kernela],33m[rootfsa],5m[kernelb],33m[rootfsb],6m[data],16m[plugin1],16m[plugin2],96m[plugin3]"
TCSUPPORT_PARTITIONS_CMDLINE_STR_CMCC="512k[bootloader],12m[rescue],1280k[reservearea],256k[romfile],5m[kernela],33m[rootfsa],5m[kernelb],33m[rootfsb],6m[data],50m[java],78m[osgi]"
TCSUPPORT_PARTITIONS_CMDLINE_STR_CU="512k[bootloader],12m[rescue],1280k[reservearea],256k[romfile],5m[kernela],33m[rootfsa],5m[kernelb],33m[rootfsb],6m[data],16m[plugin1],16m[plugin2],96m[plugin3]"
...
# TCSUPPORT_TR64_DIGEST_AUTH is not set
# TCSUPPORT_MEMORY_SHRINK is not set
# TCSUPPORT_MEMORY_SHRINK_V2 is not set
...
TCSUPPORT_APPS_NOROOT_PERM=y
# TCSUPPORT_LXC_MGR is not set
TCSUPPORT_GUI_UTF8=y
# TCSUPPORT_WLAN_MAPPING is not set
TCSUPPORT_LANMGR_NG=y
# TCSUPPORT_OPENSSL_V1_1 is not set
# TCSUPPORT_NP_FTTR is not set
# TCSUPPORT_TEST_STRESS_NG is not set
...
# TCSUPPORT_CT_RATE_PRIOR_SUPPORT is not set
...
TCSUPPORT_CMCC=y
# TCSUPPORT_CMCC_GANSU is not set
# TCSUPPORT_CMCC_SKYWORTH is not set
# TCSUPPORT_CSC_EEUROPE is not set
# TCSUPPORT_CT_PON_HLJ is not set
# TCSUPPORT_CMCC_ENTERPRISE is not set
...
# TCSUPPORT_MAP_FTTR is not set
# TCSUPPORT_CT_MULTI_LAN_PD is not set
# TCSUPPORT_CT_UBUS is not set
TCSUPPORT_BLAPI=y
# TCSUPPORT_NP_CODE_SHRINK is not set
TCSUPPORT_CHARSET_CHANGE=y
# TCSUPPORT_NP_RAM_SHRINK is not set
# TCSUPPORT_CT_IPOE_DETECT is not set
# TCSUPPORT_CT_APPROUTE is not set
# TCSUPPORT_CT_APPFILTER is not set
# TCSUPPORT_CMCC_UBUS is not set
TCSUPPORT_ARM_SECURE_BOOT=y
###### ODM FEATURE MACRO DEFINE START #######
TCSUPPORT_ODM_WLAN_FEATURE=y
TCSUPPORT_ODM_MAP_FEATURE=y
TCSUPPORT_ODM_MAP_AUTOROLE_FEATURE=y
TCSUPPORT_ODM_DM=y
TCSUPPORT_ODM_TMP_WEBPAGE=y
TCSUPPORT_ODM_WLAN_2LED_FEATURE=y
###### ODM FEATURE MACRO DEFINE END #######
TCSUPPORT_SECURITY_AUDIT_7562MESH=y
