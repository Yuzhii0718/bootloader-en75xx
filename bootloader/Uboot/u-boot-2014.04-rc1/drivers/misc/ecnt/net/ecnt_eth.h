...
#define GDMA2_BASE     		(0x1FB51500)
#define GDMA2_FWD_CFG       (GDMA2_BASE + 0x00)

#define GDMA3_BASE     		(0x1FB51100)
#define GDMA3_FWD_CFG       (GDMA3_BASE + 0x00)

#define GDMA4_BASE     		(0x1FB52500)
#define GDMA4_FWD_CFG       (GDMA4_BASE + 0x00)
 ...
 *******************************************************************/
#define CONFIG_QDMA2_BASE_ADDR                       (0x1FB56000)
#define QDMA2_REG_BASE                               (0x1FB56000)
...
#define	XSI_ETH_BASE					0x1fa09000
#define TOTAL_RX_RC_CFG 				(XSI_ETH_BASE + 0xb0)
#define TOTAL_RX_CFG 					(XSI_ETH_BASE + 0xb4)
#define TOTAL_RC_DATA_L					(XSI_ETH_BASE + 0xb8)
#define TOTAL_RC_DATA_H 				(XSI_ETH_BASE + 0xbc)
...
#define SERDES_ETHERLAN '1'
#define SERDES_ETHERWAN '2'
#define FW_PORT_DEFAULT        0
#define FW_UPGRADE             0
#define AN8811H_PHYADDR	15
