...
static int display_dram_config(void)
{
	...
	print_size((((u64)GET_DRAM_SIZE) << 20), "\n");
#else
...
# endif /* CONFIG_SYS_FLASH_CHECKSUM */
    ...
    strP = getenv("invaild_env");
    if (strP) {
    	if (strcmp("yes", strP) == 0)
    	{
...
#endif
	/* 2023.09.11: Software solution to make SPI-NAND of MTK RFB wokring */
	mtk_mw_cmd("0x1FA20218", "0x10");
