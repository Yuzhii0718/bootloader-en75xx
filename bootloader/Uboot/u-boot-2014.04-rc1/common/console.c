...
int getc(void)
{
	...
	if ((gd->flags & GD_FLG_DISABLE_CONSOLE) && (gd->flags & GD_FLG_DISABLE_RX_CONSOLE))
		return 0;
#endif
...
#ifdef CONFIG_DISABLE_CONSOLE
	if ((gd->flags & GD_FLG_DISABLE_CONSOLE) && (gd->flags & GD_FLG_DISABLE_TX_CONSOLE))
		return;
#endif
...
#ifdef TCSUPPORT_UART_TX_DISABLE
	/* Add flag to disable console output. */
	gd->flags |= GD_FLG_DISABLE_TX_CONSOLE;
#endif

#ifdef TCSUPPORT_UART_RX_DISABLE
	/* Add flag to disable console input. */
	gd->flags |= GD_FLG_DISABLE_RX_CONSOLE;
#endif
#endif
