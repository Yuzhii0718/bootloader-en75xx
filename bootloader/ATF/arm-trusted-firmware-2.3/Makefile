...
ifeq (${ARCH},aarch32)
ifneq ($(strip $(RDKB_BUILD)),)
CROSS_COMPILE_PATH = /mtkoss/gcc-arm-none-eabi/9-2019q4/bin
CROSS_COMPILE_ATF = $(CROSS_COMPILE_PATH)/arm-none-eabi-
else
...
CROSS_COMPILE_PATH = /mtkoss/aarch64/7.5.0/x86_64/bin
CROSS_COMPILE_ATF = $(CROSS_COMPILE_PATH)/aarch64-linux-gnu-
endif
...
$(eval $(call assert_boolean,ENCRYPT_BL33))
...
$(eval $(call add_define,ENCRYPT_BL33))
...
$(eval $(call add_define,TCSUPPORT_OPTEE))
endif

ifneq ($(strip $(TCSUPPORT_OPTEE_SIZE)),)
$(eval $(call add_define,TCSUPPORT_OPTEE_SIZE))	
$(eval $(call add_define_val,TCSUPPORT_OPTEE_SIZE,$(TCSUPPORT_OPTEE_SIZE)))
endif
...
ifneq ($(strip $(TCSUPPORT_UBOOT_64BIT)),)
...
sp: $(SPTOOL) $(DTBS) $(BUILD_PLAT)/sp_gen.mk
	...
	@${ECHO_BLANK_LINE}
	@echo "Built SP Images without errors"
	@${ECHO_BLANK_LINE}
endif
