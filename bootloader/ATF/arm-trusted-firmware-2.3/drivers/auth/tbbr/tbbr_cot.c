...
#if defined(IMAGE_BL2) || defined(IMAGE_BL31)	/* CONFIG_ECNT: reduce bl1 code size */
static unsigned char scp_fw_hash_buf[HASH_DER_LEN];
static unsigned char nt_world_bl_hash_buf[HASH_DER_LEN];
#endif

#if defined(IMAGE_BL2) || defined(IMAGE_BL31)	/* CONFIG_ECNT */
