 ...
 ************************************************************/
/* User-defined.B */
#define AIR_LED0_ON      (LED_ON_EVT_LINK_2500M | LED_ON_EVT_LINK_1000M)
#define AIR_LED0_BLK     (LED_BLK_EVT_2500M_TX_ACT | LED_BLK_EVT_2500M_RX_ACT | LED_BLK_EVT_1000M_TX_ACT | LED_BLK_EVT_1000M_RX_ACT)
#define AIR_LED1_ON      (LED_ON_EVT_LINK_100M)
#define AIR_LED1_BLK    (LED_BLK_EVT_100M_TX_ACT | LED_BLK_EVT_100M_RX_ACT)
#define AIR_LED2_ON      (LED_DISABLE)
#define AIR_LED2_BLK     (LED_DISABLE)
/* User-defined.E */
